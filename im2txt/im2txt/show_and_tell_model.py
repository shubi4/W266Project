...
class ShowAndTellModel(object):
  ...
  def build_inputs(self):
    ...
    if self.mode == "inference":
      ...
      image_vector.set_shape([2048, ])
      image_vectors = tf.expand_dims(image_vector, 0)
      ...
      image_vector = tf.decode_raw(encoded_image, tf.float32)
      image_vector.set_shape([2048,])
      print( "image_vector: ")
      print(image_vector)
      #tf.reshape(image_vector, [2048])
      images_and_captions.append([image_vector, caption])

      # Batch inputs.
      queue_capacity = (2 *  self.config.batch_size)
      image_vectors, input_seqs, target_seqs, input_mask = (
